...
- `ocaml.jetbrains.backend.xml` – registers backend extensions and services
- `ocaml.jetbrains.frontend.xml` – registers frontend extensions and tool windows
- `ocaml.jetbrains.shared.xml` – registers shared extensions and interfaces
